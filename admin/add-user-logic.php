<?php
    ...
    // get user data if Add user button | submit button is clicked
    if(isset($_POST['submit'])){
        ...
        if (!$firstname) {
            ...
            $_SESSION['add-user'] = "Please select an image as avatar.";
        } else {
            ...
            if ($createpassword !== $confirmpassword) {
                ...
                // casting the integer input since escaping is not needed
                ...
                if(mysqli_num_rows($user_exists_result)>0){
                    ...
                    if(in_array($extension, $allowed_extensions)){
                        ...
                        $_SESSION['add-user'] = "Invalid Image Format!";
                    }
                }
            }
        }
        ...
        // redirect to add-user page on any error
        if(isset($_SESSION['add-user'])){
            ...
            if($insert_user_result){
                ...
                $_SESSION['add-user-success'] = "User $firstname $lastname successfully added!";
